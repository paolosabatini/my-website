    ...
    <section id="blog-content" class="blog-section">
      <div class="container px-4 px-lg-5">
       <div class="row gx-4 gx-lg-5 justify-content-center">
         <div class="col-lg-0" style="margin:10px;margin-top:10px">
	   <h2> Blog </h2>
	   <br>
	   <p align="left" style="color:gray">
	     A list of my articles on several topics, mostly private productions of data analyses on open-access data.
	   </p>
           <div class="card mb-4 bg-light" >
	     <?php
	       class Article {
	         public $title; public $data; public $img; public $link;
		 public function  __construct($title, $date, $img, $link) {
		    $this->title = $title;
		    $this->date = $date;
		    $this->img = $img;
		    $this->link = $link;
	       ...
	       $articles = array();
	       $articles[] = new Article ("Pd. Meloni: the quiet wave", "February 8th, 2023", "img/blog/gm_analysis/cover.jpg", "gm_analysis.html");
	     ...
	     ?>
             ...
             <div class="row">
               <div class="col-md-2">
	         <?php echo '<img src="' . $article->img . '" width="150" height="100" style="filter: grayscale(75%)">'; ?>
               </div>

	       <div class="col-md-10"  style="margin-left:0px">
	         <div class="card-body">
		   <?php
		     echo '<h5 class="card-title"> <a href="blog-content.php?article=' . $article->link . '">' . $article->title . ' </a> </h5>';
